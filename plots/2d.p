...
set xtic auto                          # set xtics automatically
set ytic auto                          # set ytics automatically
set title "Picking a new sorting 'magic number' (10000 doubles)"
set xlabel "magic number"
set ylabel "time (microseconds) "
#set xr [100:500]
#set yr [200:8000]
set output "2d/double-smooth.svg"
plot 'data/2d/double.dat' using 1:2 title "descending" smooth bezier,\
     'data/2d/double.dat' using 1:3 title "ascending" smooth bezier,\
     'data/2d/double.dat' using 1:4 title "random" smooth bezier,\
     'data/2d/double.dat' using 1:5 title "sawtooth" smooth bezier,\
     'data/2d/double.dat' using 1:6 title "dithered" smooth bezier,\
     'data/2d/double.dat' using 1:7 title "organ pipe" smooth bezier
...
#set xr [100:500]
#set yr [200:8000]
set output "2d/double.svg"
plot 'data/2d/double.dat' using 1:2 title "descending" with lines,\
     'data/2d/double.dat' using 1:3 title "ascending" with lines,\
     'data/2d/double.dat' using 1:4 title "random" with lines,\
     'data/2d/double.dat' using 1:5 title "sawtooth" with lines,\
     'data/2d/double.dat' using 1:6 title "dithered" with lines,\
     'data/2d/double.dat' using 1:7 title "organ pipe" with lines
